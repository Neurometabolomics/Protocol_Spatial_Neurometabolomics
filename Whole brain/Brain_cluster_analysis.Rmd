...
```{r}
#setwd("/Users/isaacmarin-valencia/Desktop/STAR_Protocol/Whole brain")
...
Open the RData file
```{r}
#load("~/Whole brain/Brain_cluster_analysis.RData")
```
...
```{r}
new_refmet <- read.csv("RefMet_for_starprotocol.csv")
...
ggsave(p1 ,filename = "p1_brain.pdf",width = 7,height=4)
