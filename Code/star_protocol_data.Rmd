...
# Unir las columnas Metabolite_1 e Ion en una sola columna llamada Metabolite
...
# Pivot data to wide format for heatmap
heatmap_data <- final_data_2 %>%
  select(Metabolite, Tissue_Group, Avg_Normalized_Value) %>%
  pivot_wider(
    names_from = Tissue_Group, 
    values_from = Avg_Normalized_Value, 
    values_fill = list(Avg_Normalized_Value = 0) # Fill missing values with 0 (or NA if you prefer)
  ) %>%
  column_to_rownames("Metabolite")  # Set rownames for the heatmap

# Generate the ggplot heatmap
final_data_2 %>%
  ...
  scale_fill_gradient2(
    low = "blue", mid = "white", high = "red", midpoint = 0.2,  # Set midpoint to 0.3
...
ggsave(final_data_2_heatmap, filename = "final_data_2_heatmap.pdf", height = 7, width = 7)
