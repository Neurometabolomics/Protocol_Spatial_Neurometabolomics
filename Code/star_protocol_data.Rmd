...
remotes::install_github(
  "Neurometabolomics/Abimael-spatial-metabolomics-data-analysis-toolkit",
  subdir = "AbiMatrix",
  auth_token = "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",
  quiet = FALSE
)

Sys.setenv(GITHUB_PAT = "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")
# Install remotes package if not already installed
if (!requireNamespace("remotes", quietly = TRUE)) {
  install.packages("remotes")
}

# Install AbiMatrix from GitHub
remotes::install_github("Neurometabolomics/Abimael-spatial-metabolomics-data-analysis-toolkit/AbiMatrix")
...
# 1) Install and upload the libraries of the packages.
...
packages <- c("plyr","tidyverse", "ggpubr", "readxl", "kableExtra", "ggplot2",
              "dplyr", "stringr", "tidyr", "RColorBrewer", "forcats",
              "gridExtra", "pwr", "broom", "gt", "glue", "knitr", "broom", "pwr", "pheatmap",
              "ComplexHeatmap", "circlize", "gridExtra", "circlize", "grid", "plotly", "webshot2", "stringr", "ggalt", "ggpubr", "rstatix",
              "forcats")
...
Figure barplot from file "final_msi_data.csv"
```{r}
#Load the library:
...
# Procesar los datos y agrupar por categorías de tejido
